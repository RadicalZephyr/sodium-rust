# Sodium Rust Code of Conduct - Reporting Guide

If you believe someone is violating the code of conduct we ask that
you report it to the Sodium Rust team by emailing <CoCReportingTBD>.
__All reports will be kept confidential.__ In some cases we may
...
make a decision as to how to response guided by the [enforcement
guidelines] laid out in the Code of Conduct. Responses may include:
...
- An imposed vacation (i.e. asking someone to "take a week off" from a
  mailing list or IRC).
- A permanent or temporary ban from some or all Sodium Rust spaces
...
[enforcment guidelines]: ../../CODE_OF_CONDUCT.md#enforcement-guidelines

## Appealing

Only permanent resolutions (such as bans) may be appealed. To appeal a
moderation decision, contact the Sodium Rust team at <CoCReportingTBD>
